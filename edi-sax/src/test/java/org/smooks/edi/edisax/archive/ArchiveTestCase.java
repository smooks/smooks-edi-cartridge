...
public class ArchiveTestCase {
    ...
    public void test_produced_zip() throws IOException {
        ...
        assertEquals("org/smooks/edi/edisax/archive/Archive.class", archive.getEntryName(2));
        ...
        // Archive.class
        zipEntry = zipInputStream.getNextEntry();
        assertEquals("org/smooks/edi/edisax/archive/Archive.class", zipEntry.getName());
    }
    ...
    public void test_toFileSystem() throws IOException {
        ...
        assertTrue(new File(folder, "org/smooks/edi/edisax/archive/Archive.class").exists());
    }
